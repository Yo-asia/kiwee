...
s = '<p class="paragraph">Turnip greens yarrow ricebean rutabaga endive cauliflower sea  lettuce kohlrabi amaranth water <a href="https://www.google.pl/search?q=spinach" class="link">spinach avocado daikon Skartoffel napa cabbage <strong>asparagus winter purslane kale.</strong> Celery potato scallion desert raisin horseradish spinach carrot soko. Lotus root water spinach fennel kombu maize <span style="font-size: 19px;color: blue;">bamboo shoot green bean swiss chard seakale pumpkin onion chickpea gram corn pea.</span> Brussels sprout coriander water chestnut gourd swiss chard wakame kohlrabi beetroot carrot watercress. Corn amaranth salsify bunya nuts nori azuki bean chickweed potato bell pepper artichoke.</p>';
    ...
    if(a !== -1){
        ...
        if(b !== -1 && k.charAt(a+1)!=='/'){
            ...
            if(m===l || m.endsWith('>')===true){
                var x;
                if(k.substring(a,b+1).indexOf(' ')!==-1){
                    x = a + k.substring(a,b+1).indexOf(' ');
                }else{
                    x = b;
                }
